<template>
  ...
  <div :class="{changeFont:isActive,font:isActive}"><slot name = 'item-text'></slot></div>
  <div class="cover" :class="{active:isLeave,bgc:isTouch}" @touchstart="touch" @touchend='touchEnd'></div>
